        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <div class="container">
                        <form action="{{route('adminleadUpdate')}}" method="post">
                            @csrf
                            <div class="mb-3">
                                <input type="hidden" class="form-control" id="id" name="id" value="{{$leads->id}}" required />
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="phoneCode" name="code"  value="{{$leads->phoneCode}}" required />
                            </div>
                            <div class="mb-3">
                                <label for="remarkControl" class="form-label">Remarks</label>
                                <input class="form-control" id="remarkControl" name="remark" value="{{$leads->remark}}" rows="3" />
                            </div>
                            ...
                            <div class="mb-3">
                                <button class="btn btn-primary" type="submit">Edit Lead</button>
                            </div>
                        </form>
                    </div>
                </div>
